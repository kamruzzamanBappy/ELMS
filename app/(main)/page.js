            ...
            return (
              ...
              >
                <div className="flex  flex-col gap-4 items-center justify-between rounded-md p-6">
                  <Image
                    src={`/public/assets/images/categories/${categories.thumbnail}`}
                    alt={category.title}
                    width={100}
                    height={100}
                  />
              ...
              <Link key={course.id} href={`/courses/${course.id}`}>
                <div className="group hover:shadow-sm transition overflow-hidden border rounded-lg p-3 h-full">
                  <div className="relative w-full aspect-video rounded-md overflow-hidden">
                    <Image
                      src= {`/public/assets/images/courses/python_thumbnail.png`}
                      alt={course?.title} 
                  ...
                  1  <div className="text-lg md:text-base font-medium group-hover:text-sky-700 line-clamp-2">
                    {course?.title} 
                    </div>
                    ...
                    <div className="my-3 flex items-center gap-x-2 text-sm md:text-xs">
                      <div className="flex items-center gap-x-1 text-slate-500">
                        ...
                        <span>{course?.modules?.length}Chapter</span>
                      </div>
                    </div>
